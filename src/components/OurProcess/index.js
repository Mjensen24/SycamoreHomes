    ...
    return (
        ...
        <div className="process-container">
            ...
            <div className="process-opener">
                <h2>Each year we continue to help families design and build their custom dream home on time and on budget. In fact, with more than half a century of building custom homes in the West, we have the experience to build the home you have been dreaming of.</h2>
                <h1>HERES HOW:</h1>
            </div>
            <div className="step-one">
                <div className="step1-container">
                    ...
                    <p>We’re excited to hear your vision for the home of your dreams.  Our team will provide you with a plan to achieve your desired goals and outcome.</p>
                    <h4>We can help you:</h4>
                    <ul>
                        <li>Choose a custom floor plan that’s right for your lifestyle</li>
            ...
            <div className="step-container">
                <div className="step-info_container">
                    <div className="step-info">
                        ...
                        <h2>Financing</h2>
                        <p>Before we can break ground or even discuss where the ground should be, we need to plan your budget and connect you with a mortgage lender.</p>
            ...
            <div className="step-container">
                <div className="step-info_container">
                    <div className="step-info">
                        ...
                        <h2>Settlement</h2>
                        <p>Hand over the keys and move in! We stand behind our work with a 1, 2, 10 year home warranty</p>
